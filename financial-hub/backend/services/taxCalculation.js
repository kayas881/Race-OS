      ...
      suggestedDeductions: [
        {
          ...
          amount: 150000,
          description: 'Maximize Section 80C deductions (₹1.5 lakh)'
        },
        {
          category: 'Home Office',
          amount: 0,
          description: 'Claim home office and equipment expenses'
        },
        {
          category: 'GST',
          amount: 0,
          description: 'Keep GST input credit receipts'
        }
      ],
  ...
  async generateRecommendations(userId, incomeData, expenseData, totalTaxOwed, year, quarter) {
    ...
    if (expenseData.deductibleExpenses < incomeData.businessIncome * 0.15) {
      suggestions.push({
        ...
        amount: 0,
        description: 'Consider tracking more business expenses - you may be missing deductions'
      });
    }
    ...
    if (totalTaxOwed > incomeData.businessIncome * 0.30) {
      suggestions.push({
        ...
        amount: 0,
        description: 'High tax burden detected - consider consulting a tax professional'
      });
    }
    ...
    suggestions.push({
      ...
      amount: 0,
      description: 'Set up a dedicated business bank account for better expense tracking'
    });
