...
const InvoiceSchema = new mongoose.Schema({
  invoiceNumber: {
    type: String,
    required: true
    // Uniqueness is enforced per-user below (compound index), not globally -
    // invoice numbers are generated by counting each user's own invoices,
    // so every user's first invoice is legitimately "INV-0001".
  },
  user: {
...
// Invoice numbers only need to be unique within a single user's invoices, not globally.
